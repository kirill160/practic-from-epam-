...
public abstract class EditionFactory implements Actionable {
    ...
    protected TypeOperation typeOperation = TypeOperation.TYPE_OPERATION;
    ...
    public void show() throws EditionFactoryNotFound {
        while (typeOperation != TypeOperation.CLOSE){
            open();
    ...
    public void open() throws EditionFactoryNotFound {
        typeOperation = TypeOperation.OPEN;
        ...
        if (answer.equalsIgnoreCase(ANSWER_YES)) {
            ...
            typeOperation  = TypeOperation.CLOSE;
        } else {
    ...
    public void sendToPrint() {
        typeOperation = TypeOperation.SEND_FOR_PRINTING;
    ...
    public void refuseToPublish() {
        ...
        if (answer.equalsIgnoreCase(ANSWER_YES)) {
            ...
            typeOperation = TypeOperation.REFUSE_PUBLICATION;
    ...
    public void resume() throws EditionFactoryNotFound {
        typeOperation = TypeOperation.RESUME;
